...
.get_CRU <-
  function(pre,
           ...
           elv) {
    lat <-
      lon <- dtr_df <- pre_df <- reh_df <- tmn_df <- tmp_df <- tmx_df <-
      rd0_df <-
...
if (dtr == TRUE | tmn == TRUE | tmx == TRUE) {
  dtr_df <- readr::read_table("http://www.cru.uea.ac.uk/cru/data/hrg/tmc/grid_10min_dtr.dat.gz",
                              col_names = FALSE)
...
if (tmp == TRUE | tmn == TRUE | tmx == TRUE) {
  tmp_df <- readr::read_table("http://www.cru.uea.ac.uk/cru/data/hrg/tmc/grid_10min_tmp.dat.gz",
                              col_names = FALSE)
...
# pre ----------------------------------------------------------------------
if (pre == TRUE) {
  pre_df <- readr::read_table("http://www.cru.uea.ac.uk/cru/data/hrg/tmc/grid_10min_pre.dat.gz",
                              col_names = FALSE)
...
# reh ----------------------------------------------------------------------
if (reh == TRUE) {
  reh_df <- readr::read_table("http://www.cru.uea.ac.uk/cru/data/hrg/tmc/grid_10min_reh.dat.gz",
                              col_names = FALSE)
...
# elv ----------------------------------------------------------------------
if (elv == TRUE) {
  elv_df <- readr::read_table("http://www.cru.uea.ac.uk/cru/data/hrg/tmc/grid_10min_elv.dat.gz",
                              col_names = FALSE)
...
# wnd ----------------------------------------------------------------------
if (wnd == TRUE) {
  wnd_df <- readr::read_table("http://www.cru.uea.ac.uk/cru/data/hrg/tmc/grid_10min_wnd.dat.gz",
                              col_names = FALSE)
...
# frs ----------------------------------------------------------------------
if (frs == TRUE) {
  frs_df <- readr::read_table("http://www.cru.uea.ac.uk/cru/data/hrg/tmc/grid_10min_frs.dat.gz",
                              col_names = FALSE)
...
# rd0 ----------------------------------------------------------------------
if (rd0 == TRUE) {
  rd0_df <- readr::read_table("http://www.cru.uea.ac.uk/cru/data/hrg/tmc/grid_10min_rd0.dat.gz",
                              col_names = FALSE)
