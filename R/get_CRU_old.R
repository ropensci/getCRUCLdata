...
#'
#' This function is deprecated along with the original `get_CRU_df()` and
#'  `get_CRU_stack()`.  This is the original version of the `get_CRU()`, note
#'  all caps "CRU". The new and simplified version is just `get_cru()`. This
#'  file will be removed in a future release.
#'
