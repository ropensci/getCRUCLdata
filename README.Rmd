...
The _getCRUCLdata_ package provides functions that automate importing CRU CL2.0 climatology data into R, facilitate the calculation of minimum temperature
and maximum temperature, and formats the data into a 
[tidy data frame](http://vita.had.co.nz/papers/tidy-data.html) or a list
of [raster stack](https://cran.r-project.org/web/packages/raster/vignettes/Raster.pdf) objects for use in an R session.
...
A stable version of _getCRUCLdata_ is available from
...
For working with spatial data, _getCRUCLdata_ provides a function that create lists of [raster](https://CRAN.R-project.org/package=raster) stacks of the data.
