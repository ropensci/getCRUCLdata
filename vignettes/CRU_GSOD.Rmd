---
title: "Get CRU Data for GSOD Station Locations"
author: "Adam H Sparks"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteEngine{knitr::knitr}
  %\VignetteIndexEntry{CRU_GSOD}
...
data provided by the US National Centers for Environmental Information (NCEI) provide
global weather data.
...
CRU_GSOD <- data.frame(stations$STNID, CRU_GSOD)
names(CRU_GSOD) <- c("STNID", CRU_stack_names)
