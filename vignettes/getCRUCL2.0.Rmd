...
and return it in the data frame? Defaults to FALSE.  
* **tmx** Logical. Calculate maxium temperature (degrees Celsius) and return
...
* **wnd** Logical. Fetch 10m windspeed (metres/second) and return it in the
data frame? Defaults to FALSE.  
* **elv** Logical. Fetch elevation (kilometres) and return it in the data
frame? Defaults to FALSE.  

## Generating tidy data frames for use in R
...
```{r, eval=FALSE}
create_CRU_df(tmp = TRUE,
              reh = TRUE)
```

## Generating raster stacks for use in R
